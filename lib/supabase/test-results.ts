...
import type { DBTestResult, TestAttemptModules, TestStatus } from '@/types/db';

/**
 * Get a specific test result by user_id and test_id
 */
...
export async function getPracticeTests(userId: string) {
  ...
  // Get all test results for user (including incomplete ones)
